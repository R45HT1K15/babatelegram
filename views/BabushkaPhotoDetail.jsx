...
module.exports = function BabushkaPhotoDetail({picture, user}) {
return (
<Layout user={user}>
    ...
    <div className="photo" key={picture.id}>
      <div className="detailInfo">
        <div className="photocartochka">
          <img className="photka" src={`${picture.url}`} alt="что-то пошло не так" />
        </div>
        <div className="logos">
          <div className="logo">
          ...
          <div className="logo">
            ...
            <svg data-like="like" data-pictureid={picture.id} xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                fill="currentColor" className="bi bi-heart-fill" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
                  d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
              </svg>
              {/* {arrOfPicturesWhichUserLike.includes(picture.id) ? (
        ...
        <div id="log" className="pictureText">
        </div>
      </div>
    </div>
  </div>
